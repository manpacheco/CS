...
Mensajes_impresora: db "En un lugar de la Mancha, de cuyo nombre no quiero acordarme, no ha mucho tiempo que vivia un hidalgo de los de lanza en astillero, adarga antigua, rocin",255
...
Current_rank_message: db "Your",13,"current",13,"rank is:", 255
