...
City_locations: db "Bank","Hotel","Museum","Sport Club","Library","Airport","Harbor","Riverfront","Palace","Stock Exchange","Marketplace","Foreign Ministry"
...
Next_step_message: db 13," Use O-P SPACE to  select your next",13," step", 255
...
CurrentWeekday: db 1 ; EMPIEZA EN 1
